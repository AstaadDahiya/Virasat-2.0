...
import { ArrowUpRight, Box, IndianRupee, Users } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Welcome back, here's a summary of your shop's activity.</p>
      </div>
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>An overview of your most recently added products.</CardDescription>
            </div>
