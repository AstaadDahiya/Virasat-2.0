        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div className="flex flex-col">
              <div>
                ...
                <div className="mt-4 flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-muted-foreground text-sm ml-1">{t('product.reviews', { count: 12 })}</span>
                  </div>
                </div>
              ...
              <div>
                <h3 className="font-headline text-lg font-semibold mb-2">{t('product.materials')}</h3>
              ...
              <div className="mt-auto pt-8">
                 <div className="flex items-center gap-4 mb-4">
                    <div className="flex items-center gap-2">
                     ...
                     <p className="text-sm text-muted-foreground">{product.stock} {t('product.inStock')}</p>
                 </div>
